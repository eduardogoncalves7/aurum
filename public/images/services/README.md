...
Uma imagem por serviço, nomeada com o id do serviço + `.jpg`. O código
procura o arquivo automaticamente — não precisa editar nenhum código pra
adicionar/trocar uma imagem, só substituir o arquivo aqui.
